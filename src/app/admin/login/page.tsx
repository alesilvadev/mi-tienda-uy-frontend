...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-600 to-indigo-800 p-4 flex items-center justify-center">
        ...
        <div className="bg-white rounded-lg p-8 shadow-lg">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-4 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 disabled:bg-gray-400 transition-colors mt-6"
            >
